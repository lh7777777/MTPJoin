...
namespace BAT {
	...
	public:
		...
		virtual E* find(K const &,MBuf_des* mbdes,void* mbpool);//查找内容
		virtual bool insert(E const&,MBuf_des* mbdes,void* mbpool);//插入
	...
	protected:
		...
		void solveOverFlow(BAddTreeLeafNode<K, E>*,MBuf_des* mbdes,void* mbpool);//解决插入上溢现象 参数为节点
	...
	template<typename K, typename E>
	inline E* BAddTree<K, E>::find(K const &k,MBuf_des* mbdes,void* mbpool)
	{
	...
	template<typename K, typename E>
	inline bool BAddTree<K, E>::insert(E const &e,MBuf_des* mbdes,void* mbpool)
	{
	...
	template<typename K, typename E>
	inline void BAddTree<K, E>::solveOverFlow(BAddTreeLeafNode<K, E>*v,MBuf_des* mbdes,void* mbpool)
	{
